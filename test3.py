...
class GameWindowDetector:
    ...
    def detect_game_window(self, screenshot_gray):
        ...
        for scale in np.arange(self.scale_range[0], self.scale_range[1], self.scale_step):
            ...
            # Skip scales that are too small or too large
    ...
    def display_game_stream(self):
        ...
        while True:
            ...
            # Detect the game window if not already detected
            ...
            # Extract and display the game window
...
if __name__ == "__main__":
    ...
    # Initialize the detector and run
    detector = GameWindowDetector(template_path=TEMPLATE_PATH, threshold=0.5, monitor_index=1, scale_range=(0.5, 2.0), scale_step=0.1)
    detector.display_game_stream()
